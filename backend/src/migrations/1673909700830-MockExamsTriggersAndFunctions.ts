...
export class MockExamsTriggersAndFunctions1673909700830 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(
            `
            CREATE OR REPLACE FUNCTION update_amount_on_type_or_points_update() RETURNS trigger AS $$
                DECLARE
                    category RECORD;
                BEGIN
                    FOR category IN
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query('drop function update_amount_on_type_or_points_update() cascade;')
