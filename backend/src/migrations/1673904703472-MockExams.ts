...
export class MockExams1673904703472 implements MigrationInterface {
    name = 'MockExams1673904703472'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "mock_exam_question" ADD CONSTRAINT "FK_7d37ba13382f5ce883bb7756064" FOREIGN KEY ("typeId") REFERENCES "mock_exam_question_type"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "mock_exam_question_answer" ADD CONSTRAINT "FK_757b3a967c6f024503a224ed5d1" FOREIGN KEY ("questionId") REFERENCES "mock_exam_question"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "mock_exam_questions_amount" ADD CONSTRAINT "FK_4ce2ae88a7c856a85250cca7243" FOREIGN KEY ("typeId") REFERENCES "mock_exam_question_type"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "mock_exam_questions_amount" ADD CONSTRAINT "FK_d6e5d4f8655a7f6131da6170604" FOREIGN KEY ("categoryId") REFERENCES "drivers_license_category"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "mock_exam_questions_amount" DROP CONSTRAINT "FK_d6e5d4f8655a7f6131da6170604"`);
        await queryRunner.query(`ALTER TABLE "mock_exam_questions_amount" DROP CONSTRAINT "FK_4ce2ae88a7c856a85250cca7243"`);
