...
export class TraineeReports1672239287814 implements MigrationInterface {
    name = 'TraineeReports1672239287814'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "course_report" ("id" SERIAL NOT NULL, "traineeId" integer NOT NULL, "reportId" integer NOT NULL, CONSTRAINT "PK_b38e652f8697abd704e3f8c9b60" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "report" ("id" SERIAL NOT NULL, "driversLicenseCategoryId" integer NOT NULL, CONSTRAINT "PK_99e4d0bea58cba73c57f935a546" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "course_report" ADD CONSTRAINT "FK_faca30f0c9b2918482908d54cfd" FOREIGN KEY ("traineeId") REFERENCES "trainee"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "course_report" DROP CONSTRAINT "FK_faca30f0c9b2918482908d54cfd"`);
