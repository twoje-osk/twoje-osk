...
export class CreateMockExamQuestions1669417381870 implements MigrationInterface {
    name = 'CreateMockExamQuestions1669417381870'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "mock_exam_question" ("id" SERIAL NOT NULL, "question" character varying NOT NULL, "points" integer NOT NULL, "mediaURL" character varying, "mediaReference" character varying, "typeId" integer, CONSTRAINT "PK_7ffe7c672e75d2c6703b23a0464" PRIMARY KEY ("id"))`);
