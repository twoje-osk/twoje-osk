...
export class TraineeReports1672278987312 implements MigrationInterface {
    name = 'TraineeReports1672278987312'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "course_report" ("id" SERIAL NOT NULL, "traineeId" integer NOT NULL, "reportId" integer NOT NULL, CONSTRAINT "REL_faca30f0c9b2918482908d54cf" UNIQUE ("traineeId"), CONSTRAINT "PK_b38e652f8697abd704e3f8c9b60" PRIMARY KEY ("id"))`);
