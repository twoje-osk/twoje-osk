...
export class AddDriversLicense1657836451683 implements MigrationInterface {
    name = 'AddDriversLicense1657836451683'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "drivers_license_category" ("id" SERIAL NOT NULL, "name" text NOT NULL, CONSTRAINT "PK_21d8b8ecf2a8b80f418499d099e" PRIMARY KEY ("id"))`);
