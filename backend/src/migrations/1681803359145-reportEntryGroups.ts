...
export class reportEntryGroups1681803359145 implements MigrationInterface {
    name = 'reportEntryGroups1681803359145'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "report_entry_group" ("id" SERIAL NOT NULL, "description" character varying NOT NULL, CONSTRAINT "UQ_9734f6a1ba3ea5fb2f23cafbbf5" UNIQUE ("description"), CONSTRAINT "PK_0e6ccc5e9f0b91e7754ac01a159" PRIMARY KEY ("id"))`);
